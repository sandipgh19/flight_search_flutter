import 'package:flight_search_flutter/ticket/flight_stop_ticket.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(stop.fromLocation, style: airportNameStyle),
                  ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.only(bottom: 8.0),
                    child: Text(stop.toLocation, style: airportNameStyle),
                  ),
